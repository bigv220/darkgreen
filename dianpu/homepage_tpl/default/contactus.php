...
<div class="cophome_l_tit">
      <div class="cophome_l_tit_tit">联系我们</div>
	  <!--
EOT;
if($lfjuid==$uid){
print <<<EOT
-->
	<div class="cophome_l_tit_tit"><a href='$webdb[www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=contactus' target='_blank'>修改</a></div>
<!--
EOT;
}
print <<<EOT
...
<table width="97%" border="0" cellspacing="0" cellpadding="0"  class="rightinfo">
