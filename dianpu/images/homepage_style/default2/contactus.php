...
<div class="lysw_main_r_tit_shop_tit">
    <div class="lysw_main_r_tit_shop_tit_c">联系我们</div>
	<!--
EOT;
if($lfjuid==$uid){
print <<<EOT
-->
	 <div class="lysw_main_r_tit_shop_tit_c"><a href='$webdb[www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=contactus' target='_blank'>修改</a></div>
<!--
EOT;
}
print <<<EOT
