...
{	
	...
	if(!$shows){
		...
		echo "<select name=\"select\" onchange=\"showfid_S('$showThisId',this,'$fuid','$inputid','$type');\"><option value=\"\" style='color:#333333;'>«Î—°‘Ò</option>";
...
function get__sonfid($ckfid,$divid,$num,$table){
	...
	$fdivid="{$fuid}_".rands(5);
	$show.= "<span id=\"$fdivid\" divname='$fuid'><select name=\"select\" onchange=\"showfid_S('$divid',this,'$fuid','$inputid','$type')\"><option value=\"\" style='color:#333333;'>«Î—°‘Ò</option>";
