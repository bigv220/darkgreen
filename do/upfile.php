...
if($postfile){
	...
	echo "上传成功,<A HREF=?fn=$fn&dir=$dir&label=$_GET[label]&ISone=$_GET[ISone]&oldfile=$newfile>您可以继续或重新上传</A>";
	$fn || $fn="upfile";
...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <input id="postfile" type="file" name="postfile" style="height:20px; background-color:#EBEBEB; border: none 1px black;">
  <input  type="submit" name="Submit" value="上传文件" style="height:20px; background-color:#EBEBEB; border:1 solid #545454; cursor: pointer;">
