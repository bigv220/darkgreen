...
if($job=="list"){
	...
	while($rs = $db->fetch_array($query)){
		...
		$rs[ifyz]=$rs[yz]?"<A HREF='$admin_path&job=check&Yz=0&id=$rs[id]' style='color:#333333;'><img alt='已通过审核,点击取消审核' src='../member/images/check_yes.gif'></A>":"<A HREF='$admin_path&job=check&Yz=1&id=$rs[id]' style='color:red;'><img alt='还没通过审核,点击通过审核' src='../member/images/check_no.gif'></A>";
		$listdb[]=$rs;
	}
	get_admin_html('list');
