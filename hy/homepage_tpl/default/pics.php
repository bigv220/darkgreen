...
<div class="lysw_main_r_tit_shop_tit">
    <div class="lysw_main_r_tit_shop_tit_c">公司图库</div>
	<!--
EOT;
if($lfjuid==$uid){
print <<<EOT
-->
	 <div class="lysw_main_r_tit_shop_tit_c"><a href='$webdb[www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=pic_upload'  target='_blank'>上传图片</a></div><div class="lysw_main_r_tit_shop_tit_c"><a href='$webdb[www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=pic'  target='_blank'>管理</a></div> 
<!--
EOT;
}
print <<<EOT
...
</div><div style="text-align:center;clear:both;" class="page"><b>$showpage</b></div>
<!--
EOT;
}
print <<<EOT
