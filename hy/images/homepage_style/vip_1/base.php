...
<div class="baseinfo">
	...
	<span><a href="javascript:window.external.AddFavorite('$WEBURL','$titleDB[title]')"><img src='$Murl/images/homepage_style/$homepage_style/addcoll.gif' border=0 alt="收藏本页"></a></span>
