...
$linkdb=array("商务平台预览"=>"$webdb[www_url]/home/?uid=$uid");
$link_blank=array("商务平台预览"=>"_blank");
...
if(!$companydb[if_homepage]){
	showerr("您还没有申请企业,<a href='$Murl/member/post_company.php?action=apply'>点击这里申请企业</a>。");
