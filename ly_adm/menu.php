...
$base_menuName=array('base'=>'系统功能','article'=>'功能','member'=>'会员管理','module'=>'模块中心','stock'=>'采购订单','other'=>'插件管理');
$menu_partDB = array(
	'base'=>array('核心设置','网站常用功能管理','数据库工具','菜单管理'),
	'article'=>array('文章基本功能','内容/栏目/留言管理','静态页生成管理','更新标签内容','专题管理','辅栏目管理'),
...
$menudb=array(
	...
	'网站常用功能管理'=>array(
		...
		'应聘简历管理' => array('power'=>'alonepage_list','link'=>'index.php?lfj=cv&job=list'),
		'绿页信箱管理' => array('power'=>'alonepage_list','link'=>'index.php?lfj=mail&job=list'),
	),
	'数据库工具'=>array(
    ...
    '采购订单'=>array(
        '状态内容'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=status'),
        '买家指令付款'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=buyer_commond_pay'),
        '系统付款日'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=system_pay_time'),
        '买家终止'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=buyer_end'),
        '卖家终止'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=seller_end'),
        '古太行提现'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=gutai_withdraw'),
        '古太行收现'=> array('power'=>'member_list','link'=>'index.php?lfj=order&job=gutai_deposit'),
    ),
	'权限管理'=>array(
