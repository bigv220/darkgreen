...
if($Fid_db[$fid]){
	...
	$SQL=" LEFT JOIN {$_pre}sort S ON A.fid=S.fid WHERE S.fid in($fid_str) $SQL ";
}else{
...
$showpage2=getpage("","","list.php?style=1&fid=$fid",$rows,$totalNum);
...
require(getTpl("list_$fidDB[mid]",$FidTpl['list'])); //list_1.htm
